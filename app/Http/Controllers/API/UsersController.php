...
class UsersController extends Controller
{
    ...
    {
        $url = array(
            'url' => 'https://access.line.me/dialog/oauth/weblogin?response_type=code&client_id=1602409871&redirect_uri=http://192.168.1.15:8080/callback&state=peerapat123456789',
        );
// header('Access-Control-Allow-Origin: *');
    ...
    public function callback()
    {
        ...
        $parameter = array(
            ...
            'code' => trim($_GET['code']),
            'redirect_uri' => 'http://192.168.1.15:8080/callback',
